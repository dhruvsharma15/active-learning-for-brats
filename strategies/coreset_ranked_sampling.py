...
# -*- coding: utf-8 -*-
"""
Created on Sun Jun 23 15:22:02 2019

@author: dhruv.sharma
"""

"""
Uncertainty measures that explicitly support representative batch-mode sampling for active learning models.
"""
...
def ranked_batch(classifier,
    ...
    """
    # Clustering the pool data to find the most representative points
    print("getting the cluster centroids")
...
def informative_batch_sampling(model: Model,
    ...
    """
    coreset based ranked Batch sampling query strategy. Selects the least sure instances for labelling.
