...
if __name__ == "__main__":
    ...
    #set arguments
    model_to_load="./trained_weights/ResUnet.30.hdf5"#+sorted(os.listdir("./trained_weights/"))[-1]
    ...
    brain_seg_pred.predict_multiple_volumes(test_path,save=True,show=True)
